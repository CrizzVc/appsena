class PersonajesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personajes_path, status: :see_other, notice: "Personaje was successfully destroyed." }
  ...
  private
    ...
    def set_personaje
      @personaje = Personaje.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def personaje_params
      params.expect(personaje: [ :name, :lastname, :age, :serie, :img ])
    end
end
