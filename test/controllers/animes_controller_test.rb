...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference("Anime.count") do
      post animes_url, params: { anime: { año: @anime.año, img: @anime.img, name: @anime.name, personajes: @anime.personajes } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { año: @anime.año, img: @anime.img, name: @anime.name, personajes: @anime.personajes } }
