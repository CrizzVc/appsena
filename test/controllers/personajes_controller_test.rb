...
class PersonajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personaje" do
    assert_difference("Personaje.count") do
      post personajes_url, params: { personaje: { age: @personaje.age, img: @personaje.img, lastname: @personaje.lastname, name: @personaje.name, serie: @personaje.serie } }
    end
  ...
  test "should update personaje" do
    patch personaje_url(@personaje), params: { personaje: { age: @personaje.age, img: @personaje.img, lastname: @personaje.lastname, name: @personaje.name, serie: @personaje.serie } }
